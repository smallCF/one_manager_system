  ...
  <div style="padding:10px;">
    <div class="container">
      ...
      <el-row class="SearchRow">
        <el-col>
          ...
          >
            ...
            <el-option label="平台" value="terminal_device_group_id"></el-option>
            <el-option label="快递单号" value="terminal_device_group_id"></el-option>
            <el-option label="电话号码" value="terminal_device_group_id"></el-option>
          </el-select>
          <el-input
      ...
      >
        ...
        <el-table-column prop="date" label="购买时间"></el-table-column>
    ...
    <!-- 编辑弹出框 -->
    <el-dialog title="修改信息" :visible.sync="editVisible" :top="dialogtop">
